			...
			success:function(v){
				...
				$.each(movieData,function(index,value){
					...
					var moviecode=value.movieCd;
						...
						temp+="<li><a href=\"movieDetails.jsp?movieCd="+value.movieCd+"\" class=\"text-black\">"+value.rank+"위</a></li>";
						temp+="<li><a href=\"movieDetails.jsp?movieCd="+value.movieCd+"\" class=\"text-black\">개봉일:"+value.openDt+"</a></li>";
						temp+="</ol>";
