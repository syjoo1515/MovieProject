	...
	<div class="board-field">
		...
		<div class="col-md-8">
			...
			<div class="list-group">
				...
				<c:forEach var="a" items="${boardMVC}" varStatus="cnt">
				
				<a href="boardInfo.do?no=${a.NO}&job=info" " class="list-group-item">
					<div class="board-title">
					<!-- 답글일 경우 공백이 들어가게함 -->
					 <c:forEach var="j" begin="0" end="${a.LEV }">
                   &nbsp;&nbsp;&nbsp;&nbsp;
                   </c:forEach>
					
						<span class="board-category">[ALGORITHM]</span>
							${a.TITLE} <span class="badge">   ${a.NO ne a.REF ?'REPLY':'New'}</span>
					</div>
					<div class="board-meta"
						style="font-weight: 400; font-size: 1.2rem; color: #404040">
						<p>
							<i class="glyphicon glyphicon-user"></i> ${a.AUTHOR } 님 <i
								class="glyphicon glyphicon-comment"></i> ${a.REPLY } <i
								class="glyphicon glyphicon-ok"></i> ${a.HIT } <i
								class="glyphicon glyphicon-time"></i> ${a.REGDATE }
						</p>
					</div>
				</a>
				</c:forEach>
