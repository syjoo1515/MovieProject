...
<!--info에서 보낸 변수들 여기서 다 받음.  -->
<c:set var="job" value="${param.job}"></c:set>
<c:set var="ref" value="${param.ref}"></c:set>
<c:set var="step" value="${param.step}"></c:set>
<c:set var="lev" value="${param.lev}"></c:set>
<c:set var="pnum" value="${param.pnum}"></c:set>
...
<c:out value="${job}"></c:out>
	...
	<form action="boardInsert.do" method="post" name="insertFrm" enctype="multipart/form-data">
	<div id="write-field">
		...
		<div class="col-md-6">
			<table>
				...
				<tr>
                 ...
                 <!--  목록에서 쓰기로 넘어오는 경우는 job값이 없으므로 해당 값 처리 -->
                  <c:choose>
			...
			<div class="form-group">
				<table>
					<tr>
						<td class="td1"></td>
						<td calss="td2"><textarea name="contents" class="form-control col-sm-5"
								rows="20"></textarea></td>
					</tr>
					<tr>
					<td class="td1"></td>
