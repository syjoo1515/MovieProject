 ...
 * Generated at: 2021-10-18 12:26:59 UTC
...
public final class basicEx1_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("	$(function(){\r\n");
      out.write("		$(\"button#stud\").click(function(){\r\n");
      out.write("/* 			$.ajax({\r\n");
      out.write("				url:'/Web/studentList.do',\r\n");
      out.write("				type:'POST',\r\n");
      out.write("				dataType:'json',\r\n");
      out.write("				success:function(v){\r\n");
      out.write("					$.each(v,function(index,dom){\r\n");
      out.write(" 						$(\"tbody\").append(\"<tr id=\"+index+\">\");\r\n");
      out.write("						$.each(dom,function(index2,item){\r\n");
      out.write("							$(\"tr#\"+index).append(\"<td>\"+item+\"</td>\");\r\n");
      ...
      out.write("			}) */\r\n");
      out.write("			$.ajax({\r\n");
      out.write("				url:'/Web/studentList2.do',\r\n");
      out.write("				type:'POST',\r\n");
      out.write("				dataType:'json',\r\n");
      out.write("				success:function(v){\r\n");
      out.write("					$.each(v,function(index,dom){\r\n");
      ...
      out.write("			})\r\n");
      out.write("		});\r\n");
      out.write("		$(\"button#emp\").click(function(){\r\n");
      out.write("			$.ajax({\r\n");
      out.write("				url:'/Web/Emplist.do',\r\n");
      out.write("				type:'POST',\r\n");
      out.write("				dataType:'json',\r\n");
      out.write("				success:function(v){\r\n");
      ...
      out.write("			});\r\n");
      out.write("		});\r\n");
      out.write("		$(\"button#dept\").click(function(){\r\n");
      out.write("			$.ajax({\r\n");
      out.write("				url:'/Web/DeptInfo.do',\r\n");
      out.write("				type:'POST',\r\n");
      out.write("				data:{no:10},\r\n");
      out.write("				dataType:'json',\r\n");
      out.write("				success:function(v){\r\n");
      out.write("					console.log(v);\r\n");
      out.write("				},\r\n");
      ...
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      out.write("<button id=\"stud\">Student</button>\r\n");
      out.write("<button id=\"emp\">emp</button>\r\n");
      out.write("<button id=\"dept\">dept</button>\r\n");
      out.write("\r\n");
      out.write("<div class=\"container\">\r\n");
      out.write("  <h2>Spring Ajax</h2>\r\n");
      out.write("  <p></p>            \r\n");
      out.write("  <table class=\"table table-striped\">\r\n");
      out.write("    <thead>\r\n");
      out.write("      <tr>\r\n");
      out.write("        <th>studno</th>\r\n");
      out.write("        <th>name</th>\r\n");
      out.write("        <th>userid</th>\r\n");
      out.write("        <th>grade</th>\r\n");
      out.write("        <th>idnum</th>\r\n");
      out.write("        <th>birthdate</th>\r\n");
      out.write("        <th>tel</th>\r\n");
      out.write("        <th>height</th>\r\n");
      out.write("        <th>weight</th>\r\n");
      out.write("        <th>deptno</th>\r\n");
      out.write("        <th>profno</th>\r\n");
      out.write("      </tr>\r\n");
      out.write("    </thead>\r\n");
      out.write("    <tbody>\r\n");
      out.write("    </tbody>\r\n");
