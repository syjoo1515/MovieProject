...
<!--[if lt IE 9]>
    ...
    $(function(){
    	$("a#signin").click(function(){
    		...
    		$.ajax({
    			url:'/Web/ajaxLogin.do',
    			type:'POST',
    			dataType:'text',
    			data:{id:$("input#id").val(),pw:$("input#password").val()},
    			success:function(v){
    				if(v=='fail'){
    					$("span#check").html("<font color='red'>ID or Password Check</font>");
    					$("input#id").val('');
    					$("input#password").val('');
    				}else{
    					document.location.href='/Web/replyView.do';
    				}
    			},
    			error:function(e){
    				alert('error'+e);
				...
				<form name="LoginFrm" method="post">
					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12">
							<a href="#" id="signin" class="btn btn-sm btn-danger btn-block">SIGN IN
							<span id="check"></span></a>
						</div>0
					</div>
					<div class="login-or">
						<hr class="hr-or">
